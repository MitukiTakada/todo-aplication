...
const Home = () => {
  return (
    <div className="h-full my-16 flex relative flex-wrap">
      ...
      <img src={mainImage} alt="image" className="md:absolute lg:top-2 lg:right-52 md:w-3/5 w-10/12 mt-12 md:mt-0 right-6 mx-auto rounded lg:w-3/6"/>
    </div>
  )
}
