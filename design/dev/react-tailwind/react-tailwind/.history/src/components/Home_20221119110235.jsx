...
const Home = () => {
  return (
    <div className="h-screen pt-16 relative">
      <div className="md:mt-24 lg:ml-20 justify-center md:justify-start mx-auto max-w-xl flex flex-wrap items-center z-20 h-screen bg-[url(bg-[url('/img/hero-pattern.svg')])]">
