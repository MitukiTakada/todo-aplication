...
import productImage5 from "../images/portfolio4.jpg"
import productImage6 from "../images/portfolio4.jpg"
    ...
    <div className="container mt-10 justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full h-screen"> 
      <section className="w-full ">
        ...
        <div className="grid grid-cols-2 gap-10 lg:grid-cols-3">
          ...
          <a href="">
            <img src={productImage2} alt="" className="w-full h-36 lg:h-72 object-cover cursor-pointer "/>
          </a>
          <a href="">
            <img src={productImage3} alt="" className="w-full h-36 lg:h-72 object-cover cursor-pointer "/>
          </a>
          <a href="">
            <img src={productImage4} alt="" className="w-full h-36 lg:h-72 object-cover cursor-pointer "/>
          </a>
        </div>
      </section>
    </div>
