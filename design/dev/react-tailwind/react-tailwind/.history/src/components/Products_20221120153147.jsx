    ...
    <div className="container mt-10 justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full h-5/6"> 
      <section className="w-full ">
        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-3 sm:grid-cols-1">
          <a href="https://react-portfolio-mauve-two.vercel.app" className="transition-all duration-300 hover:translate-y-2">
          ...
          <a href="https://redux-app-three.vercel.app" className="transition-all duration-300 hover:translate-y-2">
          ...
          <a href="https://cat-image.vercel.app" className="transition-all duration-300 hover:translate-y-2">
