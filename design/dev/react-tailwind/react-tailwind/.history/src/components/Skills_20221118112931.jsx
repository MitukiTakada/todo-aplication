  ...
  return (
    <div className="h-screen pt-16">
      ...
      <section className="w-full ">
        ...
        <div className="my-16">
          <div className="w-full border border-gray-400 p-16 lg:px-32 lg:py-20 flex justify-center lg:justify-start flex-wrap spacex-">
            <div>
            ...
            <p>基本的な文法は身につけています。普段はReactを使っています。</p>
          </div>
        </div>
      </section>
    </div>
