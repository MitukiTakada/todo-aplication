  ...
  return (
    <div className="h-screen pt-16">
      ...
      <section className="w-full ">
        ...
        <div className="my-16">
          <div className="w-full border border-gray-400 p-16 lg:px-32 lg:py-20 flex justify-center lg:justify-start flex-wrap lg:space-x-32">
            <div className="mg-6 lg:mb-0 self-center">
              <SiJavascript className="text-8xl text-yellow-400"/>
            </div>
            <div className="text-center flex-wrap flex lg:text-left lg:block jus">
