  ...
  return (
    <div className="h-screen pt-16">
      ...
      <section className="w-full ">
        ...
        <div className="my-16">
          <div className="w-full border border-gray-400 p-16 lg:px-32 lg:py-20 flex justify-center lg:justify-start flex-wrap lg:space-x-32 hover:border-yellow-400">
