            ...
            <DrawerContent>
              <DrawerBody className="w-2/5 bg-slate-200 h-full p-12">
                <div className="z-20 space-y-5 text-xl">
                  ...
                  <DrawerCloseButton className="tect-sm bg-red-400 text-white p-2 rounded-md hover:bg-red-700 duration-300 transition-all text-center">閉じる</DrawerCloseButton>
                </div>
              </DrawerBody>
            </DrawerContent>
          </DrawerOverlay>
