          ...
          <DrawerOverlay>
            <DrawerContent>
              <DrawerBody className="w-2/5 bg-slate-200 h-full p-12">
                < className="z-20 space-y-5 text-xl">
                  ...
                  <DrawerCloseButton className="text-white text-md  p-2 rounded my-10 mx-auto bg-red-400 transition-all duration-300 hover:bg-red-700 ">閉じる</DrawerCloseButton>
                </div>
              </DrawerBody>
            </DrawerContent>
          </DrawerOverlay>
